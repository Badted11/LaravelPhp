...
<div class="container">
    <nav class="navbar navbar-expand-lg mt-3" style="background-color: #FF0000">
    ...
    <div class="row mt-5"  style="display: flex">
        <div class="col-4 mt-5" >
                <div>
                    ...
                    <p style="font-size: 24px">Мото Салон - подберем вам коня!</p>
                    <a href="{{route('products')}}" class="btn" style="background-color: #F22254; border-radius: 20px; font-size: 22px;
                color: white; box-shadow: 0 0 5px #F22254">Смотреть мотоциклы</a>
                </div>
